                    ...
                    {isAssetOpen && (
                        <ul className="ml-4">
                            <li className="mt-3">
                                ...
                                >
                                    <FaUser className="mr-2" /> Approval Authority
                                </Link>
                            </li>
                            <li className="mt-3">
                                <Link
                                ...
                                >
                                    <FaLocationArrow className="mr-2" /> Asset
                                </Link>
                            </li>
                            <li className="mt-3">
                                <Link
                                ...
                                >
                                    <FaUser className="mr-2" /> Category
                                </Link>
                            </li>
                            <li className="mt-3">
                                <Link
                                ...
                                >
                                    <FaUser className="mr-2" /> Depreciation
                                </Link>
                            </li>
                            <li className="mt-3">
                                <Link
                                ...
                                >
                                    <FaUser className="mr-2" /> Workflow
                                </Link>
                            </li>
                        </ul>
                    )}
